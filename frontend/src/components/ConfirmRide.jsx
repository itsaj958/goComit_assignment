...
const ConfirmRide = (props) => {
    return (
        <div>
            ...
            <h3 className='text-2xl font-bold bg-gradient-to-r from-indigo-600 to-pink-600 bg-clip-text text-transparent mb-6'>Confirm Your Ride</h3>

            <div className='flex gap-2 justify-between flex-col items-center'>
                <div className='w-24 h-24 bg-gradient-to-br from-indigo-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-lg mb-4'>
                ...
                }} className='w-full mt-6 bg-gradient-to-r from-indigo-600 to-pink-600 text-white font-semibold p-3 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all'>Confirm Ride</button>
            </div>
        </div>
    )
}
